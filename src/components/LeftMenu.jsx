    ...
    <div className="flex flex-col border-r border-neutral-700 w-100 h-screen">
      ...
      <div className="flex justify-between items-center bg-[#202d33] h-[60px] p-3">
        ...
        {/* <RoundedBtn icon={<MdPeopleAlt />} /> */}
          ...
          <button className="bg-[#202d33] text-[#8796a1]" onClick={() => loginWithRedirect()}>Log In</button>
          </li>
          ) : (
          <li><button className="bg-[#202d33] text-[#8796a1]" onClick={() => logout({ logoutParams: { returnTo: window.location.origin } })}>
      Log Out
    </button>
    </li>
          )}
